module ThriftJuliaCompiler_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ThriftJuliaCompiler_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("815b9798-8dd0-5549-95cc-3cf7d01bce66"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ThriftJuliaCompiler", artifacts_toml) for e in artifacts["ThriftJuliaCompiler"]]
...
if best_platform === nothing
    @debug("Unable to load ThriftJuliaCompiler; unsupported platform $(triplet(platform_key_abi()))")
else
